...
const SpotTable2 = ({ collection, selectedIndex }) => {
  console.log('Kokohomma');
  console.log(collection[selectedIndex].spots);
  if (!collection) {
    return (
      <div>
        ...
        <table>
          ...
          <tbody>
            {spots.length > 0 ? (
              ...
              <tr>
                <td>
                  <div className="bg-yellow-300 rounded-xl p-5 font-bold border-black border-2 ">
